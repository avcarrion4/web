...
<section id="cuerpoform">
	<section id="info">
				...
				<section class="add">
					...
					<form id="fnuevo" action="modal.php" method="post">
...
<fieldset>
    	...
    	<input type="text" id="nombre_alumno" name="nombre_alumno" value="<?php
...
?>
    	...
    	<input type="text" id="nombre2_alumno" name="nombre2_alumno" value="<?php
...
?>
    	...
    	<input type="text" id="apellido2_alumno" name="apellido2_alumno" value="<?php
...
?>
		...
		<div class="form-group">
   	 	...
   	 	<input type="text" id="cedula_alumno" name="cedula_alumno" value="<?php
...
?>
		...
		<div class="form-group">
		    ...
		    <label for="telefono_alumno">Telefono</label>
   	 	 	<input type="text" id="telefono_alumno" name="telefono_alumno" value="<?php
...
?>
		...
		<div class="form-group">
		    ...
		    <label for="correo_alumno">Correo</label>
   	 	 	 	<input type="text" id="correo_alumno" name="correo_alumno" value="<?php
...
<div class="form-group">
		    ...
		    <label for="edad_alumno">Edad</label>
   	 	 	 	 	<input type="text" id="edad_alumno" name="edad_alumno" value="<?php
...
?>
		...
		<div class="form-group">
		    ...
		    <select class="form-control" id="porcentaje_discapacidad" name="porcentaje_discapacidad" value="<?php
...
$sql2="select * from alumno where id_alumno=$aa"; 
    	...
    	while ($reg= mysql_fetch_array($registro,MYSQLI_ASSOC)) {
			...
			echo $reg['porcentaje_discapacidad'];
...
<div class="form-group">
		    ...
		    $query="select * from alumno where id_alumno=$aa";
			...
			?>
			<option value="<?php echo $r['id_discapacidad']; ?>"> <?php  echo $r['id_discapacidad'];  ?></option>
		<?php
	}
		?>
