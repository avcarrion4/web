...
<section id="cuerpoform">
	<section id="info">
				...
				<section class="add">
					...
					<form id="fnuevo" action="updateDoc.php" method="post">
...
<fieldset>
    	...
    	<input type="text" id="nombre_docente" name="nombre_docente" value="<?php
...
?>
    	...
    	<input type="text" id="nombre2_docente" name="nombre2_docente" value="<?php
...
?>
    	...
    	<input type="text" id="apellido_docente" name="apellido_docente" value="<?php
...
?>
    	...
    	<input type="text" id="apellido2_docente" name="apellido2_docente" value="<?php
...
?>
		...
		<div class="form-group">
   	 	...
   	 	<input type="text" id="cedula_docente" name="cedula_docente" value="<?php
...
?>
		...
		<div class="form-group">
		    ...
		    <label for="telefono_docente">Telefono</label>
   	 	 	<input type="text" id="telefono_docente" name="telefono_docente" value="<?php
...
?>
		...
		<div class="form-group">
		    ...
		    <label for="correo_docente">Correo</label>
   	 	 	 	<input type="text" id="correo_docente" name="correo_docente" value="<?php
